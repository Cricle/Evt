...
describe('UserAction.followAction', () => {
    ...
    it('follows a user after confirming', async () => {
        ...
        const promise = UserAction.followAction(dialog, 7, 'alice', false);
    ...
    it('unfollows a user after confirming', async () => {
        ...
        const promise = UserAction.followAction(dialog, 8, 'bob', true);
        await onPositiveClick?.();
...
//# sourceMappingURL=useUserAction.test.js.map