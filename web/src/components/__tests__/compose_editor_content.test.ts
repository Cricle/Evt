...
describe('compose editor content helpers', () => {
  it('removes embedded media from text content', () => {
    expect(
      sanitizeEditorText('<p>hello</p><figure class="image"><img src="/v1/attachments/1"></figure><p>world</p>'),
  ...
  it('keeps image assets aligned with editor html', () => {
    ...
    expect(
      syncImageAssetsWithEditor(
        '<figure class="image"><img src="/v1/attachments/2"></figure><figure class="image"><img src="/v1/attachments/3"></figure>',
        assets,
      ),
    ).toEqual([
      {
